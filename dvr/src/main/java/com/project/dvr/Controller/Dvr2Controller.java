...
public class Dvr2Controller {
	...
	@GetMapping("getdvr2/{selectDate}")
	public List<Dvr2Details> getAllDvr2DetailsBySelectDate(@PathVariable("selectDate")LocalDate selectDate){
		
		return dvr2Service.getAllDvr2DetailsBySelectDate(selectDate);
	}
	...
	public ResponseEntity<Dvr2> saveDvr2(@Valid@RequestBody Dvr2 dvr2){
		
		return new ResponseEntity<Dvr2>(dvr2Service.saveDvr2New(dvr2),HttpStatus.CREATED);
	}
	...
	@PostMapping("/dvr2newlist/saveall")
	public List<Dvr2> saveAllDvr2(@RequestBody List<Dvr2> dvr2){
		
		return dvr2Service.saveAllDvr2(dvr2);
		
	}
	
	@PostMapping("/saveall")
	public List<Dvr2Details> saveAllDvr2Details(@RequestBody List<Dvr2Details> dvr2Details){
		
		return dvr2Service.saveAllDvr2Details(dvr2Details);
