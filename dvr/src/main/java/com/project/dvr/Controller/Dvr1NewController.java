...
public class Dvr1NewController {
	...
	@PostMapping("/save")
	public ResponseEntity<Dvr1> saveDvr1(@Valid@RequestBody Dvr1 dvr1){
		
		return new ResponseEntity<Dvr1> (dvr1NewService.saveDvr1(dvr1),HttpStatus.CREATED);
	}
	...
	@PostMapping("/saveall")
		...
		public List<Dvr1> saveAllDvr3Details(@RequestBody List<Dvr1> dvr1){
		
		
		return dvr1NewService. saveAllDvr3Details(dvr1);
	}
