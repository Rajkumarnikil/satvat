...
public class Dvr3Controller {
	...
	@GetMapping("getdvr3/{selectDate}")
	public List<Dvr3Details> getAllDvr3DetailsBySelectDate(@PathVariable("selectDate")LocalDate selectDate){
		
		return dvr3Service.getAllDvr3DetailsBySelectDate(selectDate);
	}
	
	@PostMapping("/new/save")
	public ResponseEntity<Dvr3> saveDvr3new(@Valid@RequestBody Dvr3 dvr3){
		return new ResponseEntity<Dvr3>(dvr3Service.saveDvr3new(dvr3),HttpStatus.CREATED);
	}
	...
	@PostMapping("/dvr3newlist/saveall")
	public List<Dvr3> saveAllDvr3(@RequestBody List<Dvr3> dvr3){
		
		return dvr3Service.saveAllDvr3(dvr3);
		
	}
	
	@PostMapping("/saveall")
	public List<Dvr3Details> saveAllDvr3Details(@RequestBody List<Dvr3Details> dvr3Details){
		
		return dvr3Service.saveAllDvr3Details(dvr3Details);
