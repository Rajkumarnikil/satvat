...
public class Dvr2ServiceImpl implements Dvr2Service{
	...
	@Override
	public Dvr2 saveDvr2New(Dvr2 dvr2) {
	...
	@Override
	public List<Dvr2> saveAllDvr2(List<Dvr2> dvr2){
		 
		return (List<Dvr2>) dvr2NewRepository.saveAll(dvr2);
	}
	
	@Override
	public List<Dvr2Details> getAllDvr2DetailsBySelectDate(LocalDate selectDate){
		
		return dvr2Repository.findByDate(selectDate);
	}
	
	@Override
	public List<Dvr2Details> saveAllDvr2Details(List<Dvr2Details> dvr2Details){
		return (List<Dvr2Details>)dvr2Repository.saveAll(dvr2Details);
	}
