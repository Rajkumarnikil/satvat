...
public class Dvr3ServiceImpl implements Dvr3Service {
	...
	@Override
	public Dvr3 saveDvr3new(Dvr3 dvr3) {
	...
	@Override
	public List<Dvr3> saveAllDvr3(List<Dvr3> dvr3){
		
		return (List<Dvr3> )dvr3NewRepository.saveAll(dvr3);
	}
	
	@Override
	public List<Dvr3Details> getAllDvr3DetailsBySelectDate(LocalDate selectDate){
		
		return dvr3Repository.findByDate(selectDate);
	}
	
	@Override
	public List<Dvr3Details> saveAllDvr3Details(List<Dvr3Details> dvr3Details){
		
		return (List<Dvr3Details>) dvr3Repository.saveAll(dvr3Details);
	}
