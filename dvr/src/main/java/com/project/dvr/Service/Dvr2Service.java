...
public interface Dvr2Service {
	...
	Dvr2 saveDvr2New(Dvr2 dvr2);
	List<Dvr2> getAllDvr2();
	List<Dvr2> saveAllDvr2(List<Dvr2> dvr2);
	List<Dvr2Details> getAllDvr2DetailsBySelectDate(LocalDate selectDate);
	List<Dvr2Details> saveAllDvr2Details(List<Dvr2Details> dvr2Details);
